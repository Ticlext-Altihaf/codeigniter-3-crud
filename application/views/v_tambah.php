...
<div class="container">
	...
	<div class="card">
		...
		<form class="card-form" method="post" action="<?php echo site_url("create") ?>">
			<div class="input">
				<input type="text" class="input-field" name="nama" required>
				<label class="input-label">Nama</label>
			</div>
			<div class="input">
				<input type="text" class="input-field" name="alamat" required>
				<label class="input-label">Alamat</label>
			</div>
			<div class="input">
				<input type="text" class="input-field" name="perkerjaan" required>
